    ...
    <div className="min-h-screen bg-background px-6 py-10">
      <div className="mx-auto mb-8 w-full max-w-2xl space-y-1 text-center">
        ...
        <p className="text-base text-muted-foreground">
          Create a collection and upload your documents
        </p>
      </div>
      <form
        className="mx-auto w-full max-w-2xl rounded-lg border border-border bg-card p-6 space-y-4"
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Accepted: .pdf, .docx, .txt, .md (max 10MB each)
          </p>
        </div>
        <div className="pt-2">
          <Button
          ...
          >
            {isSubmitting ? <ButtonLoader /> : "Create collection"}
          </Button>
        </div>
      </form>
    </div>

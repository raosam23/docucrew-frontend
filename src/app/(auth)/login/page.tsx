        ...
        <div className="min-h-screen flex items-center justify-center bg-background">
            <Card className="w-full max-w-md p-10 space-y-4 bg-card border border-border shadow-sm">
                ...
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-[oklch(0.35_0.12_40)]">Welcome back</h1>
                ...
                {/* Footer */}
                <p className="text-sm text-center text-muted-foreground">Don't have an account? <Link href="/register" className="text-foreground font-medium underline underline-offset-4 hover:text-primary">Register</Link></p>
            </Card>
        </div>
    )
}
